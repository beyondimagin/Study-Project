...
MODULES              = rt_logging_simtarget.c rtGetInf.c rtGetNaN.c rt_nonfinite.c sfbuilder_bus_accel_wrapper.c sfbuilder_bususage.c sfbuilder_bususage_capi.c sfbuilder_bususage_data.c sfbuilder_bususage_tgtconn.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfbuilder_bus_wrapper.c
PRODUCT              = sfbuilder_bususage.exe
MAKEFILE             = sfbuilder_bususage.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2021a
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2021a
START_DIR            = C:/UNIVER~1/COURSE~1/SEMEST~3/STUDYP~1/IMPLEM~1
...
sfbuilder_bus_wrapper.obj : $(MATLAB_ROOT)/toolbox/simulink/simdemos/simfeatures/src/sfbuilder_bus_wrapper.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/toolbox/simulink/simdemos/simfeatures/src/sfbuilder_bus_wrapper.c
